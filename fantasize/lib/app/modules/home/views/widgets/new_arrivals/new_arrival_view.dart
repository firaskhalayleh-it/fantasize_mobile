...
import 'package:fantasize/app/modules/home/views/widgets/new_arrivals/widgets/new_arrival_card.dart';
            ...
            itemBuilder: (context, index) {
              if (index < controller.newArrivalsProducts.length) {
                ...
                return InkWell(
                  ...
                  child: NewArrivalCard(item: product),
                );
              } else {
                final packageIndex = index - controller.newArrivalsProducts.length;
                ...
                return InkWell(
                  ...
                  child: NewArrivalCard(item: package),
                );
              }
            },
          );
